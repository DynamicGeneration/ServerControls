/* ********************
 * Credits: Typed Styles for Child Controls Example
 * - https://msdn.microsoft.com/en-us/library/ms178656.aspx
 * *******************/
using System;
...
namespace Samples.AspNet.CS.Controls
{
    ...
    public class StyledRegister : CompositeControl
    {
        ...
        const string STR_VALIDATOR_GROUP = "StyledRegisterGroup";
        ...
        protected override void CreateChildControls()
        {
            ...
            _nameValidator.ValidationGroup = STR_VALIDATOR_GROUP;
            ...
            _emailValidator.ValidationGroup = STR_VALIDATOR_GROUP;
            ...
            submitButton.ValidationGroup = STR_VALIDATOR_GROUP;
